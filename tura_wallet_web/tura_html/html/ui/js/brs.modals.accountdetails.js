...
var BRS = (function(BRS, $, undefined) {
	...
	if (BRS.accountInfo.errorCode && BRS.accountInfo.errorCode != 5) {
	    ...
	    if (BRS.accountInfo.errorCode && BRS.accountInfo.errorCode == 5) {
		$("#account_balance_balance, #account_balance_unconfirmed_balance, #account_balance_effective_balance, #account_balance_guaranteed_balance").html("0 Tura");
		...
		$("#account_balance_balance").html(balanceNQT+ " Tura");
		$("#account_balance_unconfirmed_balance").html( unconfirmedBalanceNQT+ " Tura");
                $("#account_locked_balance").html(BRS.formatAmount(balanceNQT - unconfirmedBalanceNQT.toLocaleString()) + " Tura");
		$("#account_committed_balance").html(committedBalanceNQT + " Tura");
