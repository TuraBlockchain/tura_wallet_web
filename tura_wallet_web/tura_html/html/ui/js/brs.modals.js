...
var BRS = (function(BRS, $, undefined) {
    ...
    $(".add_recipients").on("click", function(e) {
        ...
        if ($(".same_out_checkbox").is(":checked")) {
            if (multi_out_same_recipients < 128) {
                ...
                $(".total_amount_multi_out").html(BRS.formatAmount(total_multi_out) + "Tura");
            }
        } else {
    ...
    $(document).on("click", ".remove_recipient .remove_recipient_button", function(e) {
        ...
        if ($(".same_out_checkbox").is(":checked")) {
            ...
            $(".total_amount_multi_out").html(BRS.formatAmount(BRS.convertToNQT(total_multi_out)) + " Tura");
        } else {
            multi_out_recipients--;
    ...
    $("#multi_out_fee").on("change", function(e) {
        ...
        var fee = isNaN(current_fee) ? 1 : (current_fee < 1 ? 1 : current_fee);
    ...
    $(".modal").on("hidden.bs.modal", function(e) {
        ...
        if ($feeInput.length) {
            ...
            $(this).find(".advanced_fee").html(BRS.formatAmount(BRS.convertToNQT(defaultFee))*10000 + " Tura");
        }
    ...
    $("input[name=feeNXT]").on("change", function() {
        ...
        var $fee_default=($(this).val()*10000)

        if ($feeInfo.length) {
            $feeInfo.html(BRS.formatAmount(BRS.convertToNQT($fee_default)) + " Tura");
        }
    });
